import{_ as i,c as a,o as n,ai as l}from"./chunks/framework.CidjA1rH.js";const c=JSON.parse('{"title":"说下你的vue项目的目录结构，如果是大型项目你该怎么划分结构和划分组件呢？","description":"","frontmatter":{},"headers":[],"relativePath":"frontend/vue/structure.md","filePath":"frontend/vue/structure.md","lastUpdated":1756656444000}'),p={name:"frontend/vue/structure.md"};function e(h,s,k,t,E,r){return n(),a("div",null,[...s[0]||(s[0]=[l(`<h1 id="说下你的vue项目的目录结构-如果是大型项目你该怎么划分结构和划分组件呢" tabindex="-1">说下你的vue项目的目录结构，如果是大型项目你该怎么划分结构和划分组件呢？ <a class="header-anchor" href="#说下你的vue项目的目录结构-如果是大型项目你该怎么划分结构和划分组件呢" aria-label="Permalink to &quot;说下你的vue项目的目录结构，如果是大型项目你该怎么划分结构和划分组件呢？&quot;">​</a></h1><p><img src="https://static.vue-js.com/b6cd6a60-4aba-11eb-ab90-d9ae814b240d.png" alt=""></p><h2 id="一、为什么要划分" tabindex="-1">一、为什么要划分 <a class="header-anchor" href="#一、为什么要划分" aria-label="Permalink to &quot;一、为什么要划分&quot;">​</a></h2><p>使用<code>vue</code>构建项目，项目结构清晰会提高开发效率，熟悉项目的各种配置同样会让开发效率更高</p><p>在划分项目结构的时候，需要遵循一些基本的原则：</p><ul><li>文件夹和文件夹内部文件的语义一致性</li><li>单一入口/出口</li><li>就近原则，紧耦合的文件应该放到一起，且应以相对路径引用</li><li>公共的文件应该以绝对路径的方式从根目录引用</li><li><code>/src</code> 外的文件不应该被引入</li></ul><h3 id="文件夹和文件夹内部文件的语义一致性" tabindex="-1">文件夹和文件夹内部文件的语义一致性 <a class="header-anchor" href="#文件夹和文件夹内部文件的语义一致性" aria-label="Permalink to &quot;文件夹和文件夹内部文件的语义一致性&quot;">​</a></h3><p>我们的目录结构都会有一个文件夹是按照路由模块来划分的，如<code>pages</code>文件夹，这个文件夹里面应该包含我们项目所有的路由模块，并且仅应该包含路由模块，而不应该有别的其他的非路由模块的文件夹</p><p>这样做的好处在于一眼就从 <code>pages</code>文件夹看出这个项目的路由有哪些</p><h3 id="单一入口-出口" tabindex="-1">单一入口/出口 <a class="header-anchor" href="#单一入口-出口" aria-label="Permalink to &quot;单一入口/出口&quot;">​</a></h3><p>举个例子，在<code>pages</code>文件夹里面存在一个<code>seller</code>文件夹，这时候<code>seller</code> 文件夹应该作为一个独立的模块由外部引入，并且 <code>seller/index.js</code> 应该作为外部引入 seller 模块的唯一入口</p><div class="language-js vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">js</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;">// 错误用法</span></span>
